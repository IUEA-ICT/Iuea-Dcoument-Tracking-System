...
<body>
    <nav style="background:#800000;box-shadow:0 2px 8px rgba(0,0,0,0.07);padding:0;">
        <div class="nav-container" style="max-width:1200px;margin:0 auto;display:flex;align-items:center;justify-content:space-between;">
            <div class="nav-logo" style="margin:0;">
                <a href="index.html" style="display:flex;align-items:center;text-decoration:none;">
                    <img src="https://iuea.ac.ug/sitepad-data/uploads/2020/11/Website-Logo.png" alt="IUEA Logo" style="height:54px;width:auto;margin-right:0;">
                </a>
            </div>
    ...
    <!-- Add this button just inside <body>, after <nav> -->
    <div id="theme-toggle" style="position:fixed;top:18px;right:24px;z-index:10001;cursor:pointer;">
        <img id="theme-icon" src="https://cdn4.iconfinder.com/data/icons/music-ui-solid-24px/24/moon_dark_mode_night-2-512.png" alt="Toggle theme" style="width:36px;height:36px;transition:filter 0.2s;">
    </div>
            ...
            <div style="position:relative;min-height:420px;width:100vw;display:flex;align-items:center;gap:2.5rem;justify-content:center;">
                ...
                <div style="position:relative;z-index:2;display:flex;flex:1;align-items:center;gap:2.5rem;padding:2.5rem 2rem 2rem 2rem;max-width:1200px;margin:0 auto;">
                    <div style="flex:2 1 400px;min-width:260px;">
                        ...
                        <p>
                            <a href="#features" style="color:#fff;background:var(--primary);padding:0.9rem 2.5rem;border-radius:6px;font-weight:bold;text-decoration:none;display:inline-block;font-size:1.2rem;">
    ...
    <div style="display:flex;flex-wrap:wrap;gap:1.2rem;justify-content:center;">
        <div class="feature-card" id="feature-card-centralized-storage" style="background:#fff;max-width:260px;min-width:180px;padding:1.2rem 0.7rem;border-radius:1rem;box-shadow:0 2px 12px rgba(0,0,0,0.08);transition:background 0.3s, transform 0.4s; display: flex; flex-direction: column; align-items: center;">
            <img src="https://servermall.com/upload/medialibrary/8a1/pf7lz19wfcssds6egc09015oaklc06xl/server-virtualization-4.jpg" alt="Centralized Storage" style="margin-bottom:0.7rem;width:38px;height:38px;display:block;margin-left:auto;margin-right:auto;">
            <h3 style="font-size:1.05rem;margin-bottom:0.5rem;text-align:center;">Centralized Storage</h3>
            <p style="font-size:0.97rem;text-align:center;">
        ...
        <div class="feature-card" id="feature-card-real-time-tracking" style="background:#fff;max-width:260px;min-width:180px;padding:1.2rem 0.7rem;border-radius:1rem;box-shadow:0 2px 12px rgba(0,0,0,0.08);transition:background 0.3s, transform 0.4s; display: flex; flex-direction: column; align-items: center;">
            <img src="https://spng.pngfind.com/pngs/s/437-4378486_flowcontrol-real-time-monitoring-icon-in-circle-hd.png" alt="Real-time Tracking" style="margin-bottom:0.7rem;width:38px;height:38px;display:block;margin-left:auto;margin-right:auto;">
            <h3 style="font-size:1.05rem;margin-bottom:0.5rem;text-align:center;">Real-time Tracking</h3>
            <p style="font-size:0.97rem;text-align:center;">
        ...
        <div class="feature-card" id="feature-card-easy-access" style="background:#fff;max-width:260px;min-width:180px;padding:1.2rem 0.7rem;border-radius:1rem;box-shadow:0 2px 12px rgba(0,0,0,0.08);transition:background 0.3s, transform 0.4s; display: flex; flex-direction: column; align-items: center;">
            <img src="https://www.pngkey.com/png/detail/272-2721681_the-new-soluscope-sprint-is-faster-than-ever.png" alt="Easy Access" style="margin-bottom:0.7rem;width:38px;height:38px;display:block;margin-left:auto;margin-right:auto;">
            <h3 style="font-size:1.05rem;margin-bottom:0.5rem;text-align:center;">Easy Access</h3>
            <p style="font-size:0.97rem;text-align:center;">
                ...
                <div style="position:relative;z-index:2;display:flex;flex:1;align-items:center;gap:2.5rem;padding:2.5rem 2rem 2rem 2rem;max-width:1100px;margin:0 auto;">
                    ...
                    <div style="flex:2 1 400px;min-width:260px;">
                        ...
                        <form style="margin-top:1.5rem;">
                            ...
                            <textarea placeholder="Your Message" required style="width:100%;padding:0.7rem;margin-bottom:1rem;border-radius:6px;border:1px solid #ccc;min-height:90px;"></textarea>
        ...
        <section id="login" style="width:100vw;max-width:none;margin:2.5rem 0 2rem 0;padding:2.5rem 2rem 2rem 2rem;border-radius:1.2rem;box-shadow:0 2px 16px #0001;background:#fff;text-align:center;transition:background 1.2s;">
            ...
            <a href="/login" style="color:#fff;background:var(--primary);padding:0.7rem 2.2rem;border-radius:6px;font-weight:bold;text-decoration:none;display:inline-block;margin-top:1.2rem;font-size:1.1rem;">Get Started &rarr;</a>
        </section>
    </main>
        ...
        <div style="max-width:1200px;margin:0 auto;">
            <div style="display:flex;flex-wrap:wrap;justify-content:space-between;align-items:center;">
                <div style="display:flex;align-items:center;gap:10px;">
                    <img src="https://iuea.ac.ug/sitepad-data/uploads/2020/11/Website-Logo.png" alt="IUEA Logo" style="height:32px;width:auto;">
    ...
    navToggle.addEventListener('click', () => {
        ...
        if (window.innerWidth <= 700) {
            ...
            if (navLinks.classList.contains('open')) {
                ...
                if (header) header.style.marginTop = navLinks.offsetHeight + 'px';
            } else {
                const header = document.querySelector('header');
    ...
    (function() {
        ...
        if (!chatBox || !chatToggle || !chatForm || !chatInput || !chatMessages || !chatClose) return;
    ...
    // Feature card JS hover effect: rotate and change background color
    document.querySelectorAll('.feature-card').forEach(card => {
        card.addEventListener('mouseenter', () => {
            card.style.transform = 'rotateY(15deg) scale(1.04)';
            card.style.background = '#800000';
            card.style.color = '#fff';
            card.style.transition = 'background 0.3s, color 0.3s, transform 0.4s';
        });
        card.addEventListener('mouseleave', () => {
            card.style.transform = 'none';
