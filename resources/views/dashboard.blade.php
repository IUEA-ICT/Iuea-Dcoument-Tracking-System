...
<head>
    ...
    <!-- Sidebar (light mode unchanged, dark mode custom) -->
    <div class="fixed inset-y-0 left-0 w-64 bg-gradient-to-b from-iuea-maroon to-[#5f0000] dark:bg-gradient-to-b dark:from-[#23263a] dark:to-[#3a1a1a] text-white shadow-xl">
        <!-- Logo Section -->
        ...
        <nav class="mt-8 px-4">
            <!-- Main Navigation -->
            <div class="space-y-4">
                <a href="/dashboard" class="flex items-center px-4 py-3 text-sm rounded-lg transition-colors sidebar-active">
                ...
                <a href="/documents" class="flex items-center px-4 py-3 text-sm rounded-lg hover:bg-white/5 dark:hover:bg-[#23263a] transition-colors group">
                    <i class="fas fa-file w-5 h-5 opacity-75 group-hover:opacity-100"></i>
                    <span class="ml-3">All Documents</span>
                </a>

                <a href="/documents/pending" class="flex items-center px-4 py-3 text-sm rounded-lg hover:bg-white/5 dark:hover:bg-[#23263a] transition-colors group">
                ...
                <a href="/users" class="flex items-center px-4 py-3 text-sm rounded-lg hover:bg-white/5 dark:hover:bg-[#23263a] transition-colors group">
                    <i class="fas fa-users w-5 h-5 opacity-75 group-hover:opacity-100"></i>
                    <span class="ml-3">Users</span>
                </a>

                <a href="/reports" class="flex items-center px-4 py-3 text-sm rounded-lg hover:bg-white/5 dark:hover:bg-[#23263a] transition-colors group">
            ...
            <div class="absolute bottom-0 left-0 right-0 p-4">
                ...
                <a href="{{ route('logout') }}" class="flex items-center px-4 py-3 text-sm rounded-lg hover:bg-white/5 dark:hover:bg-[#23263a] transition-colors group text-red-300 hover:text-red-200">
                    <i class="fas fa-sign-out-alt w-5 h-5 opacity-75 group-hover:opacity-100"></i>
                    <span class="ml-3">Logout</span>
                </a>
                <a href="{{ route('settings') }}" class="flex items-center px-4 py-3 text-sm rounded-lg hover:bg-white/5 dark:hover:bg-[#23263a] transition-colors group">
